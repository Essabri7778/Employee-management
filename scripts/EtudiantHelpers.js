    ...
    let row = `<tr id = "row${obj.id}">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <button class="btn btn-primary me-2">
            <a class="text-reset text-decoration-none text-truncate" href="affectationMdl.php?id_etd=${obj.id}&nom_etd=${obj.nom}&prenom_etd=${obj.prenom}" id = "affectation${obj.id}"><i class="fas fa-th"></i> Affecter des modules</a>
          </button>
...
function populateEtudiantForme(e) {
  ...
  document.getElementById("telephone").value =
    student_row.children[4].innerHTML;
