    ...
    <form id="formulaire">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                ...
                <small id="sadresse" class="form-text text-danger" hidden>Ce champ doit être rempli</small>
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                ...
                <small id="stelephone" class="form-text text-danger" hidden>Ce champ doit être rempli et de forme
                    06+8nbrs</small>
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-10">
                ...
                <small id="semail" class="form-text text-danger" hidden>Ce champ : exemple@gmail.com</small>
            </div>
        </div>
            ...
            <div class="form-group row mb-3">
                <div class="input-group">
                    <div class="form-outline flex-grow-1">
                        <input type="search" id="searchBar" class="form-control" name="search" placeholder="Chercher" />
                    </div>
                        ...
                        <td>
                            <div class="d-flex justify-content-between align-items-center">
                                <button class="btn btn-primary me-2">
                                    <a class="text-reset text-decoration-none text-truncate"
                                        href="affectationMdl.php"><i class="fas fa-th"></i> Affecter des modules</a>
                                </button>
