    ...
    <div class="d-flex justify-content-between align-items-end mb-3">
        ...
        <div>
            <button id="afficherEtd" class="btn btn-dark" data-bs-toggle="collapse" href="#listeMdl">
                <i class="fas fa-list"></i> Afficher les Modules de cet Etudiant
            </button>
        </div>
    </div>
                ...
                <table id="personnes" class="table table-bordered border-dark">
                    ...
                    <tbody id="listStudent">
                        <tr>
                            <th scope="row">1</th>
                            <td>JS</td>
                            <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, nulla ullam.
                                Aspernatur animi consequuntur quod numquam laudantium dicta harum, autem possimus nulla
                                quae tenetur. Dolore earum sunt ratione. Fugit, commodi.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
