        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="afficheEtdEval.php">Afficher Mes Evaluations</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item text-primary" href="profileEtd.php"><i
                                        class="fas fa-address-card text-primary"></i></i>
                                    Afficher Profil</a></li>
                            <li><a class="dropdown-item text-primary" href="editMdpEtd.php"><i
                                        class="fas fa-lock text-primary"></i> Modifier Mot
                                    de passe</a></li>
                            <li>
                                <hr class="dropdown-divider text-primary">
                            </li>
                            <li><a class="dropdown-item text-primary" href="../logout.php"><i
                                        class="fas fa-sign-out-alt text-primary"></i> Se
                                    Déconnecter</a>
                            </li>
                        </ul>
                    </li>
