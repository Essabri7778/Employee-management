...
<div class="container" style="padding: 20px;">
  ...
  <form id="formulaire">
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-sm-10">
        <input type="password" class="form-control" name="mdpO" id="mdpO" placeholder="Mot de passe" required>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-sm-10">
        <input type="password" class="form-control" name="mdpN" id="mdpN" placeholder="Mot de passe" required>
